...
export default function Prayer(){
  ...
  return <>
    ...
    <section className="relative pt-24 md:pt-28 overflow-hidden"><div className="absolute inset-0"><img src={IMAGES.faithPrayer} alt="Older and younger children praying with a youth leader in church" className="w-full h-full object-cover"/><div className="absolute inset-0 bg-[#25292C]/78"/></div><div className="relative max-w-5xl mx-auto px-6 py-20 md:py-28 text-center text-white"><Reveal><p className="text-xs uppercase tracking-[.28em] text-[#FFE066] font-bold">Prayer Requests</p><h1 className="mt-5 font-heading text-[2.65rem] sm:text-5xl md:text-7xl lg:text-[5.4rem] font-semibold">Let us pray <span className="italic text-[#B8ECFF]">with you.</span></h1><p className="mt-7 max-w-3xl mx-auto text-lg md:text-xl text-white/80 leading-relaxed">Whatever you are carrying, you do not have to carry it alone. Share only what you are comfortable providing and our team will lift your request up in prayer.</p></Reveal></div></section>
