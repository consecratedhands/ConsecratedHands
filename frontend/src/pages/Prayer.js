...
export default function Prayer(){
  ...
  return <>
    ...
    <section className="py-16 sm:py-20 md:py-24 bg-[#F4FBFF]"><div className="max-w-5xl mx-auto px-6 text-center"><Reveal><p className="text-xs uppercase tracking-[.28em] text-[#A66F00] font-bold">Need More Than Prayer?</p><h2 className="mt-4 font-heading text-[2.65rem] sm:text-5xl md:text-7xl font-semibold text-[#25292C]">Prayer can be the beginning of a conversation.</h2><p className="mt-6 text-lg text-[#59636A] max-w-2xl mx-auto leading-relaxed">If your request is connected to mentorship, volunteering, a family need, partnership, or another practical question, you can also contact us directly.</p><Link to="/contact" className="inline-flex items-center gap-2 mt-8 bg-[#6FD3FF] text-[#25292C] px-7 py-3.5 rounded-full font-extrabold">Contact Consecrated Hands</Link></Reveal></div></section>
  </>
}
