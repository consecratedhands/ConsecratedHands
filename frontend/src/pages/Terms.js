...
export default function Terms(){return <><Seo title="Terms of Use" description="Terms of Use for the Consecrated Hands website."/><main className="pt-40 pb-24 bg-white"><div className="max-w-4xl mx-auto px-6 md:px-12"><p className="text-xs uppercase tracking-[.28em] text-[#9B7412] font-bold">Website Terms</p><h1 className="mt-5 font-heading text-5xl md:text-7xl font-semibold text-[#17364B]">Terms of Use</h1><p className="mt-5 text-sm text-[#526B7A]">Effective August 29, 2026</p><p className="mt-8 text-lg text-[#405E70] leading-relaxed">These Terms of Use apply to your use of ConsecratedHands.com and the online forms, information, and services made available through this website.</p>
...
<Section title="Contact"><p>Questions about these terms may be sent to <a className="font-bold text-[#176F9F] hover:underline" href={`mailto:${ORG.email}`}>{ORG.email}</a>.</p></Section>
</div></main></>}
