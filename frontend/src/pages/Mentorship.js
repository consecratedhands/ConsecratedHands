...
export default function Mentorship(){return <>
  ...
  <section className="py-16 sm:py-20 md:py-32 bg-white"><div className="max-w-5xl mx-auto px-6 text-center"><Reveal><p className="text-xs uppercase tracking-[.28em] text-[#A66F00] font-bold">Take the Next Step</p><h2 className="mt-4 font-heading text-[2.65rem] sm:text-5xl md:text-7xl font-semibold text-[#25292C]">A young person may need one more person who keeps showing up.</h2><p className="mt-6 text-lg text-[#59636A] max-w-2xl mx-auto leading-relaxed">Ask about mentorship for a young person, volunteer to mentor, or partner with us to create more opportunity.</p><div className="mt-9 flex flex-wrap justify-center gap-3"><Link to="/contact" className="inline-flex items-center gap-2 bg-[#6FD3FF] text-[#25292C] px-7 py-3.5 rounded-full font-extrabold">Ask About the Program <ArrowRight size={17}/></Link><Link to="/volunteer" className="inline-flex items-center gap-2 border border-[#D8EEF8] bg-white text-[#25292C] px-7 py-3.5 rounded-full font-bold">Volunteer or Mentor <ArrowRight size={17}/></Link></div></Reveal></div></section>
</>}
