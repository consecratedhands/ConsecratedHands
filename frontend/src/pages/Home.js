...
function PrimaryButton({to,children}){return <Link to={to} className="inline-flex w-full sm:w-auto items-center justify-center gap-2 rounded-full bg-[#70CCFF] text-[#25292C] px-7 py-3.5 font-extrabold shadow-sm hover:bg-[#A8E1FF] hover:-translate-y-0.5 transition">{children}<ArrowRight size={17}/></Link>}
function SecondaryButton({to,children}){return <Link to={to} className="inline-flex w-full sm:w-auto items-center justify-center gap-2 rounded-full bg-white text-[#25292C] border border-[#D9EBF4] px-7 py-3.5 font-bold hover:border-[#7FC7EE] hover:-translate-y-0.5 transition">{children}<ArrowRight size={17}/></Link>}
  ...
  <section className="relative overflow-hidden bg-white pt-24 md:pt-28">
    ...
    <div className="relative max-w-7xl mx-auto px-6 md:px-12 py-20 md:py-28 grid lg:grid-cols-[1.08fr_.92fr] gap-12 items-center">
      <Reveal><div className="max-w-3xl">
        <div className="inline-flex items-center gap-2 rounded-full bg-white/90 border border-[#D9EBF4] px-4 py-2 text-xs font-bold tracking-[.18em] uppercase text-[#365F77]"><Sparkles size={14} className="text-[#9A6B00]"/> Christ-centered youth mentorship</div>
        <h1 className="mt-7 font-heading text-[2.75rem] sm:text-[3.35rem] leading-[.96] md:text-7xl lg:text-[5.8rem] font-semibold tracking-tight text-[#25292C]">Become Who God Set You Apart to <span className="italic text-[#9A6B00]">Be.</span></h1>
        <p className="mt-7 text-lg md:text-xl leading-relaxed text-[#47535B] max-w-2xl">Consecrated Hands walks with young people before crisis defines them—strengthening faith, stability, education, life skills, opportunity, healthy relationships, character, leadership, and service.</p>
