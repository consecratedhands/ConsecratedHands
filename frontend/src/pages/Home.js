...
export default function Home(){return <>
  ...
  <section className="py-14 sm:py-16 md:py-20 bg-[#F4FBFF]"><div className="max-w-7xl mx-auto px-6 md:px-12"><Reveal><figure><img src="/img/consecrated-hands-park-van.webp" alt="Consecrated Hands transportation van parked at a park" loading="lazy" className="w-full aspect-[16/9] object-cover rounded-[2rem] shadow-[0_24px_60px_rgba(35,105,145,.12)]"/><figcaption className="mt-3 text-xs text-center text-[#7A858C]">Transportation assistance may be available for eligible participants based on individual needs and availability.</figcaption></figure></Reveal></div></section>
</>}
