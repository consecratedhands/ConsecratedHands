...
export default function Home(){return <>
  ...
  <section className="py-16 sm:py-20 md:py-32 bg-[#F4FBFF]"><div className="max-w-7xl mx-auto px-6 md:px-12">
    <div className="grid lg:grid-cols-[.85fr_1.15fr] gap-12 md:gap-16 items-center">
    ...
    <Reveal><figure className="mt-14 md:mt-20"><img src="/img/consecrated-hands-park-van.webp" alt="Consecrated Hands youth transportation concept parked at a park" loading="lazy" className="w-full aspect-[16/9] object-cover rounded-[2rem] shadow-[0_24px_60px_rgba(35,105,145,.12)]"/><figcaption className="mt-3 text-xs text-center text-[#7A858C]">Transportation concept — building toward safe, reliable access to outings, mentorship, and opportunity.</figcaption></figure></Reveal>
  </div></section>
