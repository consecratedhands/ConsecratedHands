...
export default function Privacy(){return <><Seo title="Privacy Policy" description="Privacy Policy for Consecrated Hands."/><main className="pt-40 pb-24 bg-white"><div className="max-w-4xl mx-auto px-6 md:px-12"><p className="text-xs uppercase tracking-[.28em] text-[#A66F00] font-bold">Privacy</p><h1 className="mt-5 font-heading text-[2.65rem] sm:text-5xl md:text-7xl font-semibold text-[#25292C]">Privacy Policy</h1><p className="mt-5 text-sm text-[#59636A]">Effective August 29, 2026</p><p className="mt-8 text-lg text-[#424B52] leading-relaxed">Consecrated Hands respects the privacy of young people, families, volunteers, donors, prayer-request submitters, and community partners. This policy explains the information our website may collect, why we collect it, and the choices available to you.</p>
...
<Section title="Contact us"><p>Questions about privacy can be sent to <a className="font-bold text-[#006DAA] hover:underline" href={`mailto:${ORG.email}`}>{ORG.email}</a>.</p></Section>
</div></main></>}
